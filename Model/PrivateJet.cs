...
namespace JuraganMobil.Model
{
    internal class PrivateJet : Plane
    {
        ...
        public PrivateJet(string noPol_noReg, int year, decimal price, decimal tax, int seat, decimal rent, decimal driver, DateOnly transactionDate) : base(noPol_noReg, year, price, tax, seat)
        {
            _rent = rent;
            _driver = driver;
